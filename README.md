...
5. **Others** — Package costs, hotels, inclusions, itinerary, vouchers, tipping calculator (people stepper, page-only FX override), shopping list, FX rates; settings from the header icon
